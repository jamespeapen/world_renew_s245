...
*******************************************************************************************
**     DATE:       January 2018
**     PROGRAM:    Analysis of Bangladesh data
...
use "Outfiles\Labelled and cleaned-Bangladesh.dta", clear
...
order unique_id country respondent_num partner_n gender_n age_nr town district program_vsl program_community_leadership ///
program_agriculture program_literacy

* profile of respondents
sum gender_n age_nr program_vsl program_community_leadership ///
program_agriculture program_literacy
...
generate ActivityCount = program_vsl + program_community_leadership + program_agriculture + program_literacy
tab ActivityCount
...
sum a4_a_n- a4_m_n
* assume that missing values mean that it was not used (a4_m_n)
recode a4_m_n (. = 0)
gen NumCopingStrategiesUsed = a4_a_n+ a4_b_n + a4_c_n+ a4_d_n+ a4_e_n+ a4_f_n+ a4_g_n+ a4_h_n+ a4_i_n+ a4_j_n+ a4_k_n+ a4_l_n+ a4_m_n
* generate data for table
sum NumCopingStrategiesUsed
tab NumCopingStrategiesUsed
tab NumCopingStrategiesUsed gender_n
bysort gender_n: tab NumCopingStrategiesUsed
* test for significant difference in score between gender of respondents
...
describe  c1_compost- c1_sri, fullname
sum  c1_compost- c1_sri
sum  c1_compost- c1_sri if gender_n==0
sum  c1_compost- c1_sri if gender_n==1
tab1 c1_compost- c1_sri

* This variable has zeros for all respondents except those who responded to this section
* N = XXX out of the total sample
gen PracticeSustAgr_all=(c1_compost==1 | c1_bio_pest==1 | c1_raised_bed==1 | ///
c1_kitchen_garden==1 | c1_garden_sacks==1 | c1_floating_garden==1 | c1_sri==1)
...
replace PracticeSustAgr_agr=1 if  (c1_compost==1 | c1_bio_pest==1 | c1_raised_bed==1 | ///
c1_kitchen_garden==1 | c1_garden_sacks==1 | c1_floating_garden==1 | c1_sri==1)
...
/* Bangladesh did not do CA practices
...
* Complete CA adoption (adopting alll 3 principles)
...
describe c2_yield- c2_other_benefit, fullname
sum c2_yield- c2_other_benefit 
sum c2_yield- c2_other_benefit if gender_n==0
sum c2_yield- c2_other_benefit if gender_n==1
tab c2_other
...
* C7: Crop storage practices - PMF 116-1
* using improved storage (either PICS or metal silo)
tab1 c7_trad_bags_use c7_trad_silo_use c7_improved_silo_use c7_other_use , missing
tab1 c7_trad_bags_use c7_trad_silo_use c7_improved_silo_use c7_other_use 
sum c7_trad_bags_use c7_trad_silo_use c7_improved_silo_use c7_other_use 
...
replace UseImprovedStorage_3_4=0 if c7_trad_bags_use~=. | c7_trad_silo_use~=. |  ///
   c7_other_use~=. | c7_improved_silo_use~=. 
replace UseImprovedStorage_3_4=1 if c7_improved_silo_use==1
...
replace UseImprovedStorage_2_3_4=0 if c7_trad_bags_use~=. | c7_trad_silo_use~=. |  ///
   c7_other_use~=. | c7_improved_silo_use~=. 
replace UseImprovedStorage_2_3_4=1 if c7_trad_silo_new==1 | c7_improved_silo_new==1
...
save "Outfiles\FinalData-Bangladesh.dta", replace
